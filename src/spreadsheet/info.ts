const showSpreadSheetInfo = () => {
  ...
  // DIALOG
  // ======
  var infoDialog = new Window("dialog", undefined, undefined, { closeButton: true });
  infoDialog.text = "Spreadsheet Export Info";
  infoDialog.orientation = "column";
  infoDialog.alignChildren = ["center", "top"];
  infoDialog.spacing = 10;
  infoDialog.margins = 16;

  // GROUP1
  // ======
  var infoGroup1 = infoDialog.add("group", undefined, { name: "infoGroup1" });
  ...
  // PANEL1
  // ======
  var infoPanel1 = infoGroup1.add("panel", undefined, undefined, { name: "infoPanel1" });
  //   infoPanel1.text = "About Spreadsheet Export";
  infoPanel1.preferredSize.width = 300;
  infoPanel1.orientation = "column";
  infoPanel1.alignChildren = ["left", "top"];
  infoPanel1.spacing = 10;
  infoPanel1.margins = [20, 15, 20, 10];

  var csvExport = infoPanel1.add("statictext", undefined, undefined, {
    name: "csvExport",
    multiline: true,
  });
  csvExport.text =
  ...
  var infoDone = infoDialog.add("button", undefined, undefined, { name: "infoDone" });
  infoDone.onClick = () => {
    infoDialog.close();
  };
  infoDone.text = "CLOSE";
